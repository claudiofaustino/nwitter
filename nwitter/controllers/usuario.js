	...
	var UsuarioController = {
	    ...
	    cadastroAction: function(req, res){
	    	...
	    	if(errors){
	    		...
	    		var usuarioModel = app.models.usuario;
                        var user = {nome:req.body.usuario.nome,nickname:req.body.usuario.nickname,email:req.body.usuario.email,senha:req.body.usuario.senha};
                        console.log(user);
	    		usuarioModel.create(user, function(error, usuario){
	    			if(error){
